...
class TestDataLayer(unittest.TestCase): 
    ...
    def should_get_one_str_from_get_data(self):
    ...
    def should_get_an_integer_from_get_data(self):
    ...
    def should_get_an_errorstring_from_get_data(self):
